...
{
    public class TermalWaterExperienceTest
    {
        ...
        {
            // Arrange.
            this._exp1 = new TermalWaterExperience(1);
            this._exp2 = new TermalWaterExperience(2);
            this._exp3 = new TermalWaterExperience(3);
